...
class FrameWork(object):
    def __init__(self,Su_nbin=23, mumi = 'mum2', m12=7.54e-5, m12_nusiance='True'):
        ...
        self.T   = {'pp' : self.E['pp'] /(1 + self.m_e /(2 * self.E['pp'])),
                    'Be7': np.linspace(0.05,self.E['Be7']/(1+self.m_e/(2*self.E['Be7'])),100),
                    'pep': np.linspace(0.05,self.E['pep'][0]/(1+self.m_e/(2*self.E['pep'][0])),100),
                    'B8' : self.E['B8'] /(1 + self.m_e /(2 * self.E['B8']))}
